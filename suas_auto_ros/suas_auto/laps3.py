...
LAP_ALT_REL = -6.0
LAP_WAYPOINTS = [
    (29.9871, 30.8351, LAP_ALT_REL),   # A -- corner (start)
    (29.9871, 30.8361, LAP_ALT_REL),   # B -- corner
    (29.9881, 30.8361, LAP_ALT_REL),   # C -- corner
    (29.9881, 30.8351, LAP_ALT_REL),   # D -- corner
    (29.9876, 30.8356, LAP_ALT_REL),   # center point
    (29.9871, 30.8351, LAP_ALT_REL),   # back to A -- closes the loop
]
NUM_LAPS = 1   # 1-10 allowed by the rules; pick based on your endurance budget

# --- Search box (zigzag) -- outer corners from search_waypoints.txt ---
SEARCH_ALT_REL = -4.0
CORNER_BR = (29.9871, 30.8361)   # B -- entry corner, search flies here first
CORNER_TR = (29.9881, 30.8361)   # C
CORNER_BL = (29.9871, 30.8351)   # A
CORNER_TL = (29.9881, 30.8351)   # D -- exit corner, pattern ends here
